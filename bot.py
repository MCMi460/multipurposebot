...
async def help(ctx):
    ...
    embed.set_author(name=f"{bot.user.name}#{bot.user.discriminator}", url="https://mi460.dev/mpbot/", icon_url=f"{bot.user.avatar_url}")
    embed.set_footer(text="Check out my website and discord server!")
